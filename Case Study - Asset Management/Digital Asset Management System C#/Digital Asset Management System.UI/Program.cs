...
namespace DigitalAssetManagement.UI
{
    class Program
    {
            ...
            using (SqlConnection connection = DBUtil.SqlConnection)
            {
                ...
                while (true)
                {
                    try
                    {
                        ...
                        HandleUserChoice(choice, assetService, assetAllocationService, reservationService);
                    }
        ...
        static void HandleUserChoice(string choice, AssetService assetService, AssetAllocationService assetAllocationService, ReservationService reservationService)
        {
            ...
            switch (choice)
            {
                ...
                case "6": PerformMaintenance(assetService); break;
        ...
        static void PerformMaintenance(AssetService assetService)
        {
            // Implement maintenance logic here
            Console.WriteLine("Performing maintenance...");
            // Example: Check and update asset status, etc.
        }
